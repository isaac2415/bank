...
<body>
    ...
    <main class="container">
        ...
        <?php if (isset($_SESSION['error'])): ?>
            <div class="message message-error"><?php echo $_SESSION['error'];
                ...
                <div class="card">
                    ...
                    <form method="POST">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" id="meeting_days" name="meeting_days" pattern="^[A-Za-z]+(,[A-Za-z]+)*$"
                        ...
                        <div class="form-group">
                            ...
                            <input type="number" id="contribution_amount" name="contribution_amount" step="0.01" min="1"
                                max="1000000" required>
                        </div>

                        <div class="form-group">
                            <label for="interest_rate">Loan Interest Rate (%):</label>
                            <input type="number" id="interest_rate" name="interest_rate" step="0.01" min="0" max="100" value="0"
                                required>
                        </div>

                        <div class="form-group">
                            <label for="loan_repayment_days">Loan Repayment Period (days):</label>
                            <input type="number" id="loan_repayment_days" name="loan_repayment_days" min="1" max="365"
                                value="20" required>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <textarea id="rules" name="rules" rows="4"
                                placeholder="Enter initial rules for the group..."></textarea>
                        </div>
                ...
                if ($group_id) {
                    ...
                    <div class="card">
                        ...
                        <div class="group-info"
                            ...
                            <div onclick="navigator.clipboard.writeText('<?php echo $group['code']; ?>'); alert('Group code copied!');"
                                style="cursor: pointer;">
                                <strong>Group Code:</strong> <?php echo $group['code']; ?> 
                                <br> <strong style="color: blue;">Click to copy</strong>
                            </div>
                            ...
                            <div>
                                ...
                                <?php echo getMeetingFrequencyText($group['meeting_frequency']); ?>
                            </div>
                            <div>
                                <strong>Contribution:</strong> K <?php echo number_format($group['contribution_amount'], 2); ?> per
                                meeting
                            </div>
                            <div>
                                ...
                                <?php if ($group['status'] === 'active'): ?>
                                    <form method="POST" style="display: inline;">
                                        ...
                                        <button type="submit" class="btn btn-danger"
                                            onclick="return confirm('Are you sure you want to end this group?')">End Group</button>
                                    </form>
                                    <form method="POST" style="display: inline;">
                                        <input type="hidden" name="action" value="share_profits">
                                        <input type="hidden" name="group_id" value="<?php echo $group_id; ?>">
                                        <button type="submit" class="btn btn-warning"
                                            onclick="return confirm('Are you sure you want to share profits? This will distribute all current contributions and reset the group funds to zero.')">Share
                                            Profits</button>
                                    </form>
                                <?php else: ?>
                                    <form method="POST" style="display: inline;">
                                    ...
                                    <div style="max-height: 300px; overflow-y: auto;">
                                        <?php foreach ($rules as $rule): ?>
                                            <div style="padding: 0.75rem; border-bottom: 1px solid #eee;">
                                                ...
                                                <small>Added by <?php echo htmlspecialchars($rule['full_name']); ?> on
                                                    <?php echo date('M j, Y', strtotime($rule['created_at'])); ?></small>
                                            </div>
                                        <?php endforeach; ?>
                                    </div>
                                <?php endif; ?>
                                ...
                                <?php if ($is_treasurer): ?>
                                    <form method="POST" style="margin-top: 1rem;">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea id="rule_text" name="rule_text" rows="3" placeholder="Enter new rule..."
                                                required></textarea>
                                        </div>
                                ...
                                <?php else: ?>
                                    <?php foreach ($announcements as $announcement): ?>
                                        <div style="padding: 0.75rem; border-bottom: 1px solid #eee;">
                                            ...
                                            <small>By <?php echo htmlspecialchars($announcement['full_name']); ?> on
                                                <?php echo date('M j, Y g:i A', strtotime($announcement['created_at'])); ?></small>
                                        </div>
                                    <?php endforeach; ?>
                                <?php endif; ?>
                                <div style="margin-top: 1rem;">
                                    <a href="chat.php?group_id=<?php echo $group_id; ?>" class="btn btn-primary">Go to Group
                                        Chat</a>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="groups-grid"
                            ...
                            <?php foreach ($groups as $group): ?>
                                <div class="card" style="position: relative;">
                                    <div class="status-badge status-<?php echo $group['status']; ?>"
                                        style="position: absolute; top: 1rem; right: 1rem;">
                                        <?php echo ucfirst($group['status']); ?>
                                    </div>
                                    <h3 style="text-decoration: none;"><a
                                            href="?action=view&id=<?php echo $group['id']; ?>"><?php echo htmlspecialchars($group['name']); ?></a>
                                    </h3>
                                    <div style="margin: 1rem 0;">
                                        ...
                                        <?php if (isset($group['total_contributions'])): ?>
                                            <div><strong>Total Contributions:</strong> K
                                                <?php echo number_format($group['total_contributions'], 2); ?></div>
                                        <?php endif; ?>
                                    </div>
                                    <div style="font-size: 0.875rem; color: #666;">
